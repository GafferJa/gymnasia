  ...
  return (
    <div className='flex items-center p-5 bg-gray-700 justify-between font-inter font-normal text-lg sticky top-0 z-10'>
      <div className='ml-10 h-10 flex items-center gap-3'>
        <img src="https://clipart-library.com/images/yTkro589c.jpg" alt="" className='h-full mix-blend-screen' />
        <p className='text-white font-semibold text-2xl font-[Poppins]'>Gymnasia Admin Panel</p>
      </div>
